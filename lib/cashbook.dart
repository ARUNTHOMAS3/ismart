...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: CashBookApprovalPage(),
    );
  }
}

class CashBookApprovalPage extends StatefulWidget {
  @override
  _CashBookApprovalPageState createState() => _CashBookApprovalPageState();
}

class _CashBookApprovalPageState extends State<CashBookApprovalPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildTextField(
                        context, 'Voucher Number', voucherNumberController),
                    buildReadOnlyField(context, 'Voucher Date', voucherDate),
                    buildReadOnlyField(
                        context, 'Voucher Amount', voucherAmount),
